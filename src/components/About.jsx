...
import javaImage from '../assets/about/java.svg';
      ...
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row gap-16 items-start">
        ...
        <div data-aos="fade-left" data-aos-delay="200" className="flex-1 text-white mt-8 md:mt-0 relative z-20">
          ...
          <p className="text-lg font-bold mb-12 leading-relaxed max-w-3xl text-red-50">
            Hi, my name is <span className="text-black text-xl font-black mx-1 tracking-wide uppercase">Shivaani S</span>, a passionate full-stack developer based in [Location], dedicated to crafting clean, functional, and highly scalable web applications.
          </p>
